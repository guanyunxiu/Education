package com.gyx.education.education.net.util;
...
public class RetrofitClient {
   ...
   public void upload(String url, Map<String, RequestBody> params, BaseSubscriber<BaseResponse> subscriber) {
        apiService.uploadFile(url,params)
                .compose(schedulersTransformer())
                .compose(transformer())
                .subscribe(subscriber);
    }
    ...
    public void upload3(String url, RequestBody requestBody, BaseSubscriber<RequestBody> subscriber) {
        apiService.upLoadFile(url,requestBody)
                .compose(schedulersTransformer())
                .compose(transformer())
                .subscribe(subscriber);
    }
    public Observable<ResponseBody> uploadFile(String des, Map<String,RequestBody> body) {
        return apiService.uploadFilePhoto(des, body);
    }
